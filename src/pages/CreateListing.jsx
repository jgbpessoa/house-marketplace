...
function CreateListing() {
  ...
  const onSubmit = async (e) => {
    ...
    if (geolocationEnabled) {
      ...
      if (location === undefined || location === "") {
        setLoading(false);
        return toast.error("Plase enter a correct address");
      }
    } else {
    ...
    setLoading(false);
    toast.success("Success! Your listing was posted");
  ...
  const onMutate = (e) => {
    ...
    // e.target.type === "number" && (value = Number(value));

    setFormData({ ...formData, [e.target.id]: value });

    e.target.files && setFormData({ ...formData, images: e.target.files });
  };
